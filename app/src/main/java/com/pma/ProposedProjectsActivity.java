...
public class ProposedProjectsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        proposedProjects.add(new ProposedProject("<b>" + "1. Project Name: <br/><br/>" + "</b>" +
                "Continuation of the development of export of responsibilities per unit in public sector organizations by the Government Gazette.<br/>", "<b>" + "Project Description:<br/>" +
                "</b>" + "The aim of this project is to expand the existing text mining code by the Government Gazette, with the addition of database support and the creation of an automatic detection system." +
                ...
                "assigned to them and the types of services they must provide in accordance with their institutional framework.<br/>"));
        proposedProjects.add(new ProposedProject("<b>" + "2. Project Name: <br/><br/>" + "</b>" +
                "Create a better user interface in LibreOffice and OpenOffice.<br/>", "<b>" + "Project Description:<br/>" + "</b>" +
                ...
                "Change the interface of icons, toolbar and menu to achieve the same menu functionality as Microsoft Word.<br/>"));
        proposedProjects.add(new ProposedProject("<b>" + "3. Project Name: <br/><br/>" + "</b>" +
                "Development of an application for digitization of the collections and functions of the Byzantine Museum.<br/>", "<b>" + "Project Description:<br/>" + "</b>" +
                ...
                "(eg educational community, researchers and scientists, groups of visitors, families, tourists).<br/>"));
        proposedProjects.add(new ProposedProject("<b>" + "4. Project Name: <br/><br/>" + "</b>" +
                "Developing an application that is going to help the user search for fellow travelers where they intend to go to the same destination.<br/>","<b>" + "Project Description:<br/>" +
                ...
                "The application will provide the user security in the selection of his fellow travelers and will be adapted to his needs.<br/>"));
        proposedProjects.add(new ProposedProject("<b>" + "5. Project Name: <br/><br/>" + "</b>" +
                "Development of a mobile application that detects diseases and ailments.<br/>", "<b>" + "Project Description:<br/>" + "</b>" +
                ...
                "examination.<br/>"));
        proposedProjects.add(new ProposedProject("<b>" + "6. Project Name: <br/><br/>" + "</b>" +
                "Development of an application for mobile phones that makes the stops of public transport \"smarter\".<br/>", "<b>" + "Project Description:<br/>" + "</b>" +
                ...
                "and allow passengers to perform daily tasks such as paying bills, sending parcels or filling out a phone.<br/>"));
        proposedProjects.add(new ProposedProject("<b>" + "7. Project Name: <br/><br/>" + "</b>" +
                "Development of application and support of online space for resale of products and services.<br/>", "<b>" + "Project Description:<br/>" + "</b>" +
                ...
                "by other users of the application.<br/>"));
        proposedProjects.add(new ProposedProject("<b>" + "8. Project Name: <br/><br/>" + "</b>" +
                ...
                "to country.<br/>", "<b>" + "Project Description:<br/>" + "</b>" +
                ...
                "itineraries. <br/>"));
        proposedProjects.add(new ProposedProject("<b>" + "9. Project Name: <br/><br/>" + "</b>" +
                "Development of a mobile phone application for stress detection.<br/>", "<b>" + "Project Description:<br/>" + "</b>" +
                ...
                "wirelessly to vital signs that change when the person is stressed and when this happens will notify the user.<br/>"));
        proposedProjects.add(new ProposedProject("<b>" + "10. Project Name: <br/><br/>" + "</b>" +
                "Application development for people with disabilities.<br/>", "<b>" + "Project Description:<br/>" + "</b>" +
                ...
                "employee to help them access.<br/>"));
        proposedProjects.add(new ProposedProject("<b>" + "11. Project Name: <br/><br/>" + "</b>" +
                "Creating a website where student work is organized.<br/>", "<b>" + "Project Description:<br/>" + "</b>" +
                ...
                "assignments, they will be automatically integrated in the application and will diagrammatically represent his course in the assignments of his school.<br/>"));
        proposedProjects.add(new ProposedProject("<b>" + "12. Project Name: <br/><br/>" + "</b>" +
                "Application development for missing animals.<br/>", "<b>" + "Project Description:<br/>" + "</b>" +
                ...
                "the application from any region of Greece.<br/>"));
        proposedProjects.add(new ProposedProject("<b>" + "13. Project Name: <br/><br/>" + "</b>" +
                "Develop an application that will allow you to locate bicycles according to the current location of the user.<br/>", "<b>" + "Project Description:<br/>" + "</b>" +
                ...
                "the application will inform him about the prices and the time priced by each store in the surrounding area.<br/>"));
        proposedProjects.add(new ProposedProject("<b>" + "14. Project Name: <br/><br/>" + "</b>" +
                "Creating a website for student career guidance.<br/>", "<b>" + "Project Description:<br/>" + "</b>" + 
                ...
                "It is a website where the user will enter some data concerning his interests and as a result he will be offered suggested professional fields that he could follow.<br/>"));
    ...
    class ProposedProjectsAdapter extends ArrayAdapter<ProposedProject> {
        ...
        public View getView(int position, View convertView, @NonNull ViewGroup parent){
            ...
            text1.setText(Html.fromHtml(proposedProjects.get(position).name));
            text2.setText(Html.fromHtml(proposedProjects.get(position).description));
