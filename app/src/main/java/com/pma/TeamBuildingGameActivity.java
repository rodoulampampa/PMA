...
public class TeamBuildingGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team_buillding_games);
        ...
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "1. Game of Possibilities <br/><br/>" + "</b>" +
                ...
                "<b>" + "Objective:" + "</b>" + "This team building exercise inspires creativity and individual innovation.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "2. Winner/Loser <br/><br/>" + "</b>" +
                ...
                "<b>" + "Objective:" + "</b>" + "Participants discover how to reframe negative situations into learning experiences together.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "3. Purpose Mingle<br/><br/>" + "</b>" +
                ...
                "<b>" + "Objective:" + "</b>" + "Improves meeting productivity and makes attendees think about how they're going to contribute, rather than: + " +
                "just what they hope to get out of the meeting.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "4. Scavenger Hunt<br/><br/>" + "</b>" +
                ...
                "<b>" + "Objective:" + "</b>" + "Great team bonding exercise that helps break up office cliques by encouraging people to work with" +
                "colleagues from other teams, departments, or just social circles.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "5. Human Knot<br/><br/>" + "</b>" +
                ...
                "<b>" + "Objective:" + "</b>" + "This game for team building relies heavily on good communication and teamwork." +
                "It also results in a lot of great stories for the water cooler chat in the workplace.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "6. The Perfect Square<br/><br/>" + "</b>" +
                ...
                "team members to guide each other in the right direction.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "7. The Mine Field<br/><br/>" + "</b>" +
                ...
                "<b>" + "Objective:" + "</b>" + "This game focuses on trust, communication, and effective listening. This activity makes a great" +
                "team building beach game as well.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "8. The Egg Drop<br/><br/>" + "</b>" +
                ...
                "for an \"eggcellent\" corporate team building game! Make sure you have an extra supply of eggs in case some break (ew!) during" +
        ...
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "9. The Barter Puzzle<br/><br/>" + "</b>" +
                ...
                "the entire team must come to a consensus before a decision is made.<br/>"));
        ...
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "12. This is Better Than That<br/><br/>" + "</b>" +
                ...
                "<b>" + "Objective:" + "</b>" + "This exercise inspires team creativity in problem solving. The idea is to not make the scenarios too" +
                "easy so it becomes obvious which objects are most useful.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "13. Back-to-Back Drawing<br/><br/>" + "</b>" +
                ...
                "image is). After a set amount of time, have each set of partners compare their images and see which team drew the most accurate replica.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "14. Office Trivia<br/><br/>" + "</b>" +
                ...
                "the year is most common for birthdays among our employees?\" This is a quick team building activity that tests how observant your team is.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "15. Marshmallow Spaghetti Tower<br/><br/>" + "</b>" +
                ...
                "stand on its own (that means no hands or other objects supporting it!) for five seconds.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "16. Community Service<br/><br/>" + "</b>" +
                ...
                "to your team or reflects your company values, get out of the office, and do some good for your community and your team.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "17. Masterpiece Murals<br/><br/>" + "</b>" +
                ...
                "displayed in your office as a mural, or placed throughout your workspace.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "18. Campfire/Memory Wall<br/><br/>" + "</b>" +
                ...
                "share their memory and post it on the wall, forming a positive memory cloud.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "19. Plane Crash<br/><br/>" + "</b>" +
                ...
                "consensus. This game focuses on communication and negotiation skill building.<br/>"));
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "20. Spider Web <br/><br/>" + "</b>" +
                ...
                "get all their members through the opening between the strings without touching it. Increase the difficulty by taping more pieces of string" +
        ...
        teamBuildingGame.add(new TeamBuildingGame("<b>" + "21.Whose Office Is It, Anyway?<br/><br/>" + "</b>" +
                ...
                "coffee mugs, desktop backgrounds, or the view outside their window.<br/>"));
